...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Link.is_deleted'
        db.add_column('submissions_link', 'is_deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Album.is_deleted'
        db.add_column('submissions_album', 'is_deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Link.is_deleted'
        db.delete_column('submissions_link', 'is_deleted')

        # Deleting field 'Album.is_deleted'
        db.delete_column('submissions_album', 'is_deleted')
    ...
    models = {
        ...
        'submissions.link': {
            ...
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 25, 17, 57, 30, 506739)'}),
