...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Artist.is_deleted'
        db.add_column('submissions_artist', 'is_deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Artist.is_deleted'
        db.delete_column('submissions_artist', 'is_deleted')
    ...
    models = {
        ...
        'submissions.link': {
            ...
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 25, 17, 39, 44, 613322)'}),
