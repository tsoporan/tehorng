...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('accounts_userprofile', 'verification_key')


    def backwards(self, orm):
        
        # Adding field 'UserProfile.verification_key'
        db.add_column('accounts_userprofile', 'verification_key', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
