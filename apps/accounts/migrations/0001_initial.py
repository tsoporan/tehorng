...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_userprofile', (
            ...
            ('warning', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('verification_key', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('accounts', ['UserProfile'])

        # Adding model 'OnlineUser'
        db.create_table('accounts_onlineuser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('accounts', ['OnlineUser'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('accounts_onlineuser')
    ...
    models = {
        ...
        'accounts.userprofile': {
            ...
            'verification_key': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'warning': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'})
        },
        'auth.group': {
